...
class ProposalPenelitianD extends StatelessWidget {
        ...
        child: Scaffold(
          ...
          body: SafeArea(
            child: RefreshIndicator(
              onRefresh: uProposal.dosenPenelitian,
              child: Obx(() {
                if (uProposal.isLoading.value) {
                ...
                } else if (uProposal.listPenelitian.isEmpty) {
                  return Center(
                  ...
                  return Container(
                    ...
                    child: ListView.builder(
                        itemCount: uProposal.listPenelitian.length ?? 0,
                        shrinkWrap: true,
                        itemBuilder: (context, i) {
                          var x = uProposal.listPenelitian[i];
                          return InkWell(
                            onTap: () {
                              Get.to(
                                () => DetailProposal(),
