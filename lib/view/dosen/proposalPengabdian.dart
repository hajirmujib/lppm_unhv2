...
import 'package:lppm_unhv2/view/searchUsulanPengabdian.dart';
import 'package:lppm_unhv2/widget/ItemList.dart';
import 'package:lppm_unhv2/widget/myColor.dart';
import 'package:sizer/sizer.dart';

class ProposalPengabdianD extends StatelessWidget {
    ...
    return DefaultTabController(
        ...
        child: Scaffold(
          floatingActionButton: FloatingActionButton(
              ...
              onPressed: () {
                showSearch(
                    context: context, delegate: SearchUsulanPengabdian());
              }),
          appBar: AppBar(
          ...
          body: SafeArea(
            child: RefreshIndicator(
              onRefresh: uProposal.dosenPengabdian,
              child: Obx(() {
                if (uProposal.isLoading.value) {
                ...
                } else if (uProposal.listPengabdian.isEmpty) {
                  return Center(
                  ...
                  return Container(
                    ...
                    child: ListView.builder(
                        itemCount: uProposal.listPengabdian.length ?? 0,
                        shrinkWrap: true,
                        itemBuilder: (context, i) {
                          var x = uProposal.listPengabdian[i];
                          return InkWell(
                            onTap: () {
                              Get.to(
                                () => DetailProposal(),
