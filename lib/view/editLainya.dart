...
class EditLainya extends StatelessWidget {
                ...
                child: Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        child: TextFormField(
                          initialValue: lainyaC.keterangan,
                          validator: (text) {
                            if (text == null || text.isEmpty) {
                              return "Tidak Boleh Kosong";
                            }
                        ...
                        child: Row(
                          ...
                          children: [
                            Obx(() => Container(
                                ...
                                width: 60.w,
                                height: 20.h,
                                child: lainyaC.fileTxt.value == ""
                                    ? lainyaC.file.value.path == ""
                                        ? Center(
                                            child: Text(
                                            "File Name",
                                            style:
