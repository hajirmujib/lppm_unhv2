...
class EditJurnal extends StatelessWidget {
      ...
      appBar: AppBar(
        ...
        actions: [
          InkWell(
            onTap: () {
              jurnalC.editJurnal();
              print(jurnalC.coverTxt.value.toString());
            },
            child: Container(
              width: 40,
              height: 40,
                ...
                child: Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        child: TextFormField(
                          initialValue: jurnalC.judulJurnal,
                          validator: (text) {
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Obx(() => ClipRRect(
                                  borderRadius: BorderRadius.circular(10),
                                  child: jurnalC.coverTxt.value == ""
                                      ? jurnalC.cover.value.path != ""
                                          ? Image.file(
                                              jurnalC.cover.value,
                                              width: 30.w,
                                            )
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Obx(() => ClipRRect(
                                  borderRadius: BorderRadius.circular(10),
                                  child: jurnalC.abstrakTxt.value == ""
                                      ? jurnalC.abstrak.value.path != ""
                                          ? Image.file(
