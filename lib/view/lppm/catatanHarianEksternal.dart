...
class CatatanHarianEksternal extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          "Catatan Harian " + catatanC.jenis.value + " Eksternal",
          style: TextStyle(
      ...
      body: SafeArea(
        child: RefreshIndicator(
          onRefresh: catatanC.jenis.value == "Penelitian"
              ? penelitian.getPenelitianEksternal
              : pengabdian.getPengabdianEksternal,
          child: catatanC.jenis.value == "Penelitian"
                  ...
                  if (penelitian.isLoading.value) {
                    ...
                    return Container(
                      ...
                      child: ListView.builder(
                          itemCount:
                              penelitian.penelitianEksternalList.length ?? 0,
                          shrinkWrap: true,
              ...
              : Obx(() {
                  if (pengabdian.isLoading.value) {
                  ...
                  } else if (pengabdian.penelitianEksternalList.isEmpty) {
                    return Center(
                      child: SingleChildScrollView(
                        child: Container(
                          decoration: BoxDecoration(
                    ...
                    return Container(
                      ...
                      child: ListView.builder(
                          itemCount:
                              pengabdian.penelitianEksternalList.length ?? 0,
                          shrinkWrap: true,
                          itemBuilder: (context, i) {
                            var x = pengabdian.penelitianEksternalList[i];
                            return InkWell(
                              onTap: () {
                                Get.to(
                                  () => DetailCatatanHarian(),
