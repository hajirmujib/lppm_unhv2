...
class EditPaten extends StatelessWidget {
                ...
                child: Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        child: TextFormField(
                          initialValue: patenC.judulInvansi,
                          validator: (text) {
                      ...
                      Container(
                        child: TextFormField(
                          initialValue: patenC.noPermohonan,
                          validator: (text) {
                            if (text == null || text.isEmpty) {
                              return "Tidak Boleh Kosong";
                            }
                      ...
                      InkWell(
                        ...
                        child: Container(
                          child: TextFormField(
                            // initialValue: patenC.tglPengajuan,
                        ...
                        child: Row(
                          ...
                          children: [
                            Obx(() => Container(
                                ...
                                width: 60.w,
                                height: 20.h,
                                child: patenC.fileTxt.value == ""
                                    ? patenC.file.value.path == ""
                                        ? Center(
                                            child: Text(
                                            "File Name",
                                            style:
                                    ...
                                    : Center(
                                        child: Text(patenC.fileTxt.value),
                                      ))),
                            Padding(
